...
def main(args):
    with open(args.label_path, "r", encoding="utf-8", newline="") as label_file, open(
        args.training_path, "w", encoding="utf-8", newline=""
    ) as training_file, open(
        args.testing_path, "w", encoding="utf-8", newline=""
    ) as testing_file:
